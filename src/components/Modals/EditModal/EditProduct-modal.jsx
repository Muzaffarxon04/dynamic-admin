...
export default function AddCompanyModal({ row, route, getDatas, products, countries }) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      inforu: row?.inforu,
      infoen: row?.infoen,
      title1uz: row?.title1uz,
      title1ru: row?.title1ru,
      title1en: row?.title1en,
      info1uz: row?.info1uz,
      info1ru: row?.info1ru,
      info1en: row?.info1en,
      box_color1: row?.box_color1,
      text_color1: row?.text_color1,
      title2uz: row?.title2uz,
      title2ru: row?.title2ru,
      title2en: row?.title2en,
      info2uz: row?.info2uz,
      info2ru: row?.info2ru,
      info2en: row?.info2en,
      box_color2: row?.box_color2,
      text_color2: row?.text_color2,
      submit: null,
    },
    ...
    onSubmit: async (values, helpers) => {
      try {
        ...
        const response = await fetch(BaseUrl + `/brand/${row._id}`, {
          method: 'PATCH',
...
onClose={handleClose}>
          {localization.modal.addWarehouse.edit}
