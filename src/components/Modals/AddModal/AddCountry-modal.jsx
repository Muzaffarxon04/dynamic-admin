    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, helpers) => {
            try {
                ...
                createData(type === "mobile" && subId === "all" ? '/mobile/maincategory/create' : type === "mobile" && subId !== "all" ? '/mobile/category/create' : '/category/create', subId !== "all" ? newData2 : newData, "POST", getDatas, onFinish);
