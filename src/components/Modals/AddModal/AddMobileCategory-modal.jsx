  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, helpers) => {
        try {
          ...
          image.current?.files[0] && formData.append('logo', image.current?.files[0]);
          image.current?.files[0] && formData.append('main_image', image1.current?.files[0]);
          image.current?.files[0] && formData.append('images', image2.current?.map(item => item));
            formData.append('title', values.nameuz);
          formData.append('tags', values.nameen);
